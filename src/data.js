...
export const projects = [{
        ...
        description: "An exclusive App, where you can reserve to share a meal with others, Share your interesting meal and Review the meals.",
        image: mealshare,
    ...
    },
    {
        title: "Giphy Search",
        subtitle: "HTML, CSS and JavaScript(Fetch API and DOM Manipulation)",
        description: "You can search the gifs here and limit the number of results you want",
        image: gifSearch,
